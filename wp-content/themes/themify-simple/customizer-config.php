...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'sticky_header_link_font' => array(
			...
			'selector' => '.fixed-header #header a, .transparent-header #headerwrap.fixed-header a',
			'prop' => 'font',
		),
		...
		'page_title_color' => array(
			...
			'selector' => '.page-title, .page-category-title-wrap .page-title, .page-category-title-wrap .page-category-title, .page-category-title-wrap .page-category-title',
			'prop' => 'color',
		),
		...
		'page_sub_heading_color' => array(
			...
			'selector' => '.page-category-title-wrap .page-category-description',
			'prop' => 'color',
		),
