...
-----------------------------------------------------------------------------------*/
class WC_PSAD_Uploader extends WC_PSAD_Admin_UI
{
	...
	public function upload_input ( $name_attribute, $id_attribute = '', $value = '', $attachment_id = 0, $default_value = '', $field_name = '', $class = '', $css = '', $description = '', $strip_methods = true ) {
		...
		$output .= '<input id="upload_'.$id_attribute.'" class="a3rev-ui-upload-button a3_upload_button button" type="button" value="'.__( 'Upload', 'wc_psad' ).'" /> '.$description;
...
global $wc_psad_uploader;
$wc_psad_uploader = new WC_PSAD_Uploader();
